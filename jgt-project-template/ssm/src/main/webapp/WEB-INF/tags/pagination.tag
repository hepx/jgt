...
<%@ attribute name="pageInfo" type="org.hepx.jgt.ssm.common.mybatis.pagehelper.Page" required="true"%>
...
<%
    ...
    int end = Math.min(begin + (paginationSize - 1), pageInfo.getTotalPage());
...
<div class="pagination">
    <ul>
        ...
        <li><a href="?page=${current+1}&sortType=${sortType}&${searchParams}">&gt;</a></li>
        <li><a href="?page=${pageInfo.totalPage}&sortType=${sortType}&${searchParams}">&gt;&gt;</a></li>
        <%}else{%>
        <li class="disabled"><a href="#">&gt;</a></li>
        <li class="disabled"><a href="#">&gt;&gt;</a></li>
        <%} %>
