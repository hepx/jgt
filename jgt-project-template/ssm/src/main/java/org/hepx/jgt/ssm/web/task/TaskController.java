package org.hepx.jgt.ssm.web.task;
...
import org.hepx.jgt.ssm.service.account.ShiroDbRealm.ShiroUser;
import org.hepx.jgt.ssm.service.task.TaskService;
...
public class TaskController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Page<Task> tasks = taskService.getUserTask(searchParams, pageNumber, pageSize);
